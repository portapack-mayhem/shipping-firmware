...
For more information on Splash Screens, see the following Wiki pages:
	https://github.com/portapack-mayhem/shipping-firmware/wiki/Create-a-custom-splash-screen
	https://github.com/portapack-mayhem/shipping-firmware/wiki/File-manager
